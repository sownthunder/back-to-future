...
// texture variable to hold the "DROP CEMENT" button image
public var dropCementImg : Texture;
...
function OnGUI ()
{
	...
	// ONLY if you are in the CTruck...
	if (inVehicle)
	{

		Debug.Log("this is going to stay true if Marty is in Cement Vehicle");

		// allow the dropping of cement via GUI button
		if (GUI.Button(Rect ((Screen.width - 860), 175, (Screen.width / 3), (Screen.height / 8)), dropCementImg, buttonGUIStyle))
		{
